<?php
    ...
    $sqlCrearCalificacion = "INSERT INTO calificacion 
    (id_maestro,id_usuario,id_materias,calificacionGeneral,Dificultad,
    calificacion_obtenida,volver_a_tomar,comentario) 
    VALUES ($id_maestro,$id_usuario,$id_materia,$cal_gral,$dificultad,
