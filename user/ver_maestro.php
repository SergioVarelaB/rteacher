...
if(isset($_SESSION["id_usuario"])){
    $id_escula_user = $_SESSION["id_escuela"];
...
<body class="w3-theme-l5">
    ...
    <?php
        ...
        //echo "<h1>Maestro $nombre $apellios </h1> <a href = $urlCalificar>Calificar</a>";
        //echo "<h2>Resumen</h2>";
        //echo "<label>Calificacion promedio: $cal_prom /10</label><br>";
        //echo "<label>Dificultad promedio: $dif_prom /10</label><br>";
        //echo "<label>L@ volverian a escoger: $volver_elegir%</label><br>";
